...
* The ``tests`` folder contains:
  ...
  - Example tests that you should replace with your own meaningful tests (file: ``test_awesome``)
...
* For convenience, the package version is stored in a single place: ``awesome/__version__.py``. For updating the version number, you only have to change this file.
...
If you want to contribute to the development of My awesome project,
